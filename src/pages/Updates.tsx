...
const UPDATES: Update[] = [
  {
    ...
    changes: [
      ...
      "Implemented FSM Creator",
      "Choose from 3 different types of FSMs ; NFA, DFA, eNFA",
      "Add simulation buttons",
      "Bug fixes for DFA state relabeling and visualization",
      "Simulation speed reduced for better clarity",
      "FSM Creator Improvements: Better state transitions and improved user interface"
    ],
    futureUpdates: [
      "No updates for now"
    ]
