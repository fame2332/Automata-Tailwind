      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {TECHNOLOGIES.map((tech) => (
            <div
              key={tech.name}
              className="group relative bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden transform transition-all duration-500 hover:shadow-2xl hover:-translate-y-2"
            >
              <div className="p-8">
                {/* Logo container with floating animation */}
                <div className="relative mb-6">
                  <div 
                    className="w-20 h-20 mx-auto mb-4 p-4 rounded-xl bg-white dark:bg-gray-700 shadow-md 
